    ...
    return SafeArea(
      child: Scaffold(
        body: Container(
          ...
          color: context.dynamicColor(light: ColorResources.blackBG, dark: ColorResources.blackBG,),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextWidget(text: "Lorem ipsum dolor sit amet consectetur. Porta at id hac vitae. Et tortor at vehicula euismod mi viverra.",
                      style: TextStyle(
                        fontSize: 12.sdp,
                        fontWeight: FontWeight.w400,
                        color: context.dynamicColor(light: ColorResources.greyTextloginScreen, dark: ColorResources.white)),
                      ),
                      ...
                      Row(
                        children: [
                          SizedBox(
                            width: 80.sdp,
                            child: coutryCodeDropdown("+91", ["+91", "+56"], (value){
                              countryCode = value!;
                            }, context),
                          ), SizedBox(width: 10.sdp,),
                          Expanded(child: CommonTextFormField(controller: phoneController, hintText: "Enter Mobile Number"))
                        ],
                      ),
                      SizedBox(height: context.mediaQuerySize.height*0.40.sdp,),
                        Center(
                          child: CommonButton(
                            ...
                            isBoarder: true,
                            buttoncolor: ColorResources.blackBG.withOpacity(0.2),
                            boarderColor: ColorResources.white.withOpacity(0.6), onTap: (){
                              Navigator.pushReplacementNamed(context, AppRoute.home);
                            }, 
                            height: 50.sdp, width: 140.sdp, 
                            child: Row(
                            children: [
                              TextWidget(text: "Continue",
                                              style: TextStyle(
                                                fontSize: 14.sdp,
                                                fontWeight: FontWeight.w400,
                                                color: context.dynamicColor(light: ColorResources.white, dark: ColorResources.white)),
                                               ...
                                               Container(
                                                ...
                                                child: Center(child: Icon(Icons.arrow_forward_ios, color: ColorResources.white, size: 18.sdp,),),
                                                ),
                            ],
                          )),
                        )
